...
<body>
  ...
  <div class="row vh-100 row min-vw-100">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-2 container" style="background-color: #EBF1F1">
      ...
      <div style="background-image: url(public/images/voiture.jpg);background-size: cover; background-repeat: no-repeat;height: 100vh; width: 100%; opacity: 0.70;">
      <?= $content ?>
